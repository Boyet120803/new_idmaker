    ...
    <style>      
     ...
     /* I-center ang image horizontally at vertically */
    ...
    <main class="flex-1 ml-64">
            ...
            <div class="flex items-center justify-between px-6 py-4">
                ...
                <div class="px-6 py-2 border-t border-gray-100">
                    <div class="flex items-center text-sm">
                        <a href="#" class="text-gray-500 hover:text-primary">Add Student</a>
        ...
        <div class="px-6 pb-6 -mt-8">
            <div class="overflow-x-auto">
                <form>
                    <div class="p-6 mb-6 rounded-lg shadow-lg bg-white">
                        <h2 class="text-black font-light mb-6" style="font-size: 18px; color: rgb(174, 174, 174)">Basic Info</h2>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="float-input-group">
                            <input type="text" name="firstname" class="float-input" required />
                            <label class="float-label">First Name</label>
                            <span class="float-highlight"></span>
                        </div>
                        <div class="float-input-group">
                            <input type="text" name="middlename" class="float-input" />
                            <label class="float-label">Middle Name</label>
                            <span class="float-highlight"></span>
                        </div>
                        <div class="float-input-group">
                            <input type="text" name="lastname" class="float-input" required />
                            <label class="float-label">Last Name</label>
                            <span class="float-highlight"></span>
                        </div>
                        <div class="float-input-group">
                            <input type="date" name="birthdate" class="float-input" required />
                            <label class="float-label"></label>
                            <span class="float-highlight"></span>
                        </div>
                        <div class="float-input-group">
                            <input type="number" name="age" class="float-input" required />
                            <label class="float-label">Age</label>
                            <span class="float-highlight"></span>
                        </div>
                        <div class="float-input-group">
                            <input type="text" name="student_id" class="float-input" required />
                    ...
                    <div class="p-6 mb-6 rounded-lg shadow-lg bg-white">
                        <h2 class="text-black font-light mb-6" style="font-size: 18px; color: rgb(174, 174, 174)">Address & Contact</h2>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="float-input-group">
                            <input type="text" name="barangay" class="float-input" required />
                            <label class="float-label">Barangay</label>
                            <span class="float-highlight"></span>
                        </div>
                        <div class="float-input-group">
                            <input type="text" name="municipality" class="float-input" required />
                            <label class="float-label">Municipality</label>
                            <span class="float-highlight"></span>
                        </div>
                        <div class="float-input-group">
                            <input type="text" name="contact" class="float-input" required />
                            <label class="float-label">Contact</label>
                            <span class="float-highlight"></span>
                        </div>
                        <div class="float-input-group">
                            <input type="text" name="emergency_contact" class="float-input" />
                    ...
                    <div class="p-6 rounded-lg shadow-lg bg-white">
                        <h2 class="text-black font-light mb-6" style="font-size: 18px; color: rgb(174, 174, 174)">Media</h2>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label for="image" class="block mb-2" style="font-size: 17px; color: rgb(44, 42, 42);">Upload Image</label>
                            <input type="file" id="image" name="image" data-default-file="assets/img/signature.png" class="dropify" data-height="140" accept="image/*" required />
                        </div>
                        <div>
                            <label for="signature" class="block mb-2" style="font-size: 17px; color: rgb(44, 42, 42);">Upload Signature</label>
                            <input type="file" id="signature" name="signature" data-default-file="https://cdn-icons-png.flaticon.com/512/149/149071.png"class="dropify" data-height="140" accept="image/*" required />
                        </div>
                        </div>
                    </div>
                   <div class="mt-6">
                        <button type="submit"
                            class="w-40 h-12 px-6 py-2 bg-blue-600 text-white text-sm font-medium rounded-md shadow hover:bg-blue-700 transition-all duration-200">
                            Create
                        </button>
                    </div>
                </form>
