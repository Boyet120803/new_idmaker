...
<script>
    ...
    async function saveEmployee(status, reason) {
        ...
        try {
            const pendingRes = await fetch(`${APP_URL}/api/employeeshowpending/${employeeId}`, {
                method: "GET",
                headers: {
            ...
            const response = await fetch(`${APP_URL}/api/employee-complete-store`, {
                method: 'POST',
                headers: {
                    'Authorization': 'Bearer ' + localStorage.getItem("auth_token")
                },
      ...
      document.addEventListener("DOMContentLoaded", async () => 
    {
          ...
          try {
              const response = await fetch(`${APP_URL}/api/employeeshowpending/${employeeId}`, {
                  method: "GET",
                  headers: {
                      "Accept": "application/json",
                      "Authorization": "Bearer " + localStorage.getItem("auth_token")
